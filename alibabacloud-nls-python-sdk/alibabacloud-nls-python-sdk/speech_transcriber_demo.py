...
def process(client, appkey, token,audio_name):
...
if __name__ == "__main__":
    ...
    text = "同学您好，我们是上汽通用五菱校招小组，我们将于10月12日晚上七点在四川大学望江校区基础教学楼A604举办宣讲会，请问您是否有意向参加呢？"
    audio_name = 'sy_audio.wav'

    process(client, appkey, token,audio_name)
